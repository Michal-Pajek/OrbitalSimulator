...
namespace TextIdEntries
{
    ...
    inline constexpr std::array<TextIdEntry, TEXT_ID_COUNT> textIdEntries{ {
        ...
        TextIdEntry{ TextId::DefaultSaveNameIs,                             "default_save_name_is" },
        ...
        TextIdEntry{ TextId::EnterNewSaveName,                              "enter_new_save_name" },
        ...
        TextIdEntry{ TextId::EnterScenarioNumberOrZeroToCancel,             "enter_scenario_number_or_zero_to_cancel" },
        ...
        TextIdEntry{ TextId::LoadScenario,                                  "load_scenario" },
        ...
        TextIdEntry{ TextId::Overwrite,                                     "overwrite" },
        ...
        TextIdEntry{ TextId::QuestionDoYouWantToLoadIt,                     "question_do_you_want_to_load_it" },
        TextIdEntry{ TextId::QuestionDoYouWantToRunTheSimulationNow,        "question_do_you_want_to_run_the_simulation_now" },
        TextIdEntry{ TextId::QuestionDoYouWantToSaveTheScenario,            "question_do_you_want_to_save_the_scenario" },
        TextIdEntry{ TextId::QuestionDoYouWantToUseThisSaveName,            "question_do_you_want_to_use_this_save_name" },
        ...
        TextIdEntry{ TextId::SaveAsNewVersion,                              "save_as_new_version" },
        ...
        TextIdEntry{ TextId::ScenarioLoadedSuccessfully,                    "scenario_loaded_successfully" },
        TextIdEntry{ TextId::ScenarioLoadingCanceled,                       "scenario_loading_canceled" },
        TextIdEntry{ TextId::ScenarioLoadingFailed,                         "scenario_loading_failed" },
        ...
        TextIdEntry{ TextId::ScenarioSavedSuccessfully,                     "scenario_saved_successfully" },
        ...
        TextIdEntry{ TextId::ThereAreNoSavedScenarios,                      "there_are_no_saved_scenarios" },
        TextIdEntry{ TextId::ThereIsOnlyOneSavedScenario,                   "there_is_only_one_saved_scenario" },
        TextIdEntry{ TextId::ThisSaveNameAlreadyExists,                     "this_save_name_already_exists" },
